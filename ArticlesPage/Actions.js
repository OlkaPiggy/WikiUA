...
<div className="block">
    ...
    <span className="number-of-likes">6</span>
</div>
...
function addToFavorites() {
    ...
    const favoriteArticle = document.createElement('li');
    favoriteArticle.textContent = article.textContent;
    const favoritesList = document.getElementById('favoritesList');
    favoritesList.appendChild(favoriteArticle);
}
